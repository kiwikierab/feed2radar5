...
BACKTITLETEXT="Radar NZ Setup Script w/ ADSBX installer"

whiptail --backtitle "$BACKTITLETEXT" --title "$BACKTITLETEXT" --yesno "Thanks for choosing to share your data with Radar5!\n\nradar5.nz is a co-op of ADS-B/Mode S/MLAT feeders from around the New Zealand. This script will configure your current your ADS-B receiver to share your feeders data with Radar5 and ADS-B Exchange.\n\nWould you like to continue setup?" 13 78
CONTINUESETUP=$?
...
EOF
    ...
    #
    # Create the radar.nz dump1090 script.
    #
...
EOF
    ...
    # Kill any currently running instances of the rasarnx_ netcat_maint.sh script.
